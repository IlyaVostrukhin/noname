...
<div id="shoppingCart">
    ...
    <table class="table table-bordered">
        ...
        <tr id="product278009" class="item">
            <td class="text-center"><img class="small" src="/media/socks.jpg" alt="Prestigio SH398187"><br>Prestigio SH398187</td>
        ...
        <tr id="product278014" class="item">
            <td class="text-center"><img class="small" src="/media/socks.jpg" alt="EvroMedia NU6353951"><br>EvroMedia NU6353951</td>
